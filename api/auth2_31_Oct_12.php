...
if(isset($_REQUEST["userId"]) && is_numeric($_REQUEST["userId"]))
  {
	  ...
	  $pstrcond	= "id=".$userId;
	  $usrRow	= Utility::getTableData("tblUsers",$pstrcond,"subaccountSid, subaccountAuthToken");
  }


$accountSid = "";
$authToken = ""; 
if(isset($usrRow[0]["subaccountSid"]))
	$accountSid = $usrRow[0]["subaccountSid"];
if(isset($usrRow[0]["subaccountAuthToken"]))
	$authToken = $usrRow[0]["subaccountAuthToken"];
...
if(!empty($accountSid) && !empty($authToken))
  {
	...
	//$appSid = "AP62507f0b14ef693cca172c150c434dca";	 //testsubacct
