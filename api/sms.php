...
<form action="" method="post">
  ...
  <textarea id="txtMsg" name="txtMsg" cols="58" rows="6"  style="margin:10px auto 0; padding-top:10px; padding-left:10px; font-size:26px; width:480px; border: 1px solid #999999; box-shadow: 1px 2px 10px #BBBBBB; font-weight:bold;" placeholder="Enter message" onkeydown="removeerrors('txtMsgerr');"></textarea><br/>  
