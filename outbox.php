...
$query = "SELECT SQL_CALC_FOUND_ROWS VoiceSms.id,VoiceSms.voiceMsgTitle,VoiceSms.fromId, VoiceSms.vSmsFile, VoiceSms.readStatus, VoiceSms.dateAdded, Users.firstName,  Users.lastName FROM tblVoiceSms AS VoiceSms INNER JOIN tblUsers AS Users ON VoiceSms.toId = Users.id WHERE VoiceSms.fromId='".$_SESSION['userId']."' ORDER BY VoiceSms.id desc";
...
<body>
<p style="margin:240px 0px 16px; "> <a href="inbox.php">Inbox</a> | <a href="dashboard.php">Back</a> | <a href="logout.php">Logout</a></p>
<br/>
